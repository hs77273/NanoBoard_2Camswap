...
class MyWindow(QWidget):
    def __init__(self):
        ...
        self.cabin_thread.seatobjects_detected.connect(self.update_seat_object)
    ...
    def stop_cabinmonitoring(self):
        for key, rectangle in self.rectangles_dict.items():
            ...
            rectangle.status_text_label.setStyleSheet("color: White; font-weight: bold; font-size: 20px;")
            rectangle.image_label.setPixmap(self.Empty_pixmap)
            rectangle.object_text_label.setText("No objects")
            rectangle.object_text_label.setStyleSheet("color: White; font-weight: bold; font-size: 20px;")
